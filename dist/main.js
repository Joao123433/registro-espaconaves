...
function newSpaceship(spaceshipName, namePilot, crewLimit) {
    const spaceship = {
        name: spaceshipName,
        pilot: namePilot,
        crewLimit: crewLimit,
...
function addCrewToSpaceshipExist(member, spaceship) {
...
function sendSpaceshipToMission(crewMinimum, spaceship) {
